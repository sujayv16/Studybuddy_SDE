      ...
      try {
        ...
        if(isValidTime(time)){
          ...
          if (response.ok) {
            ...
            // Update the room data to reflect the change
            const updatedRooms = rooms.map(room => {
              if (room.chatid === key1) {
                return { ...room, meetTime: time };
              }
              return room;
            });
            ...
            alert("Failed to update meeting time. Please try again.");
          }
        ...
        alert("An error occurred while updating the meeting time.");
      }
   };
